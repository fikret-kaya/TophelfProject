...
public class PlaceForTagActivity extends AppCompatActivity
    ...
    private TextView tag, rating;
    private ListView commentsV, userSearchList, placeTagSearchList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t_name = bundle.getString("tag");
        setTitle(t_name);

        try {
            relations = new GetTimelineConn().execute(t_name).get();
        ...
        setContentView(R.layout.activity_place_for_tag);
    ...
    class GetTimelineConn extends AsyncTask<String, Void, ArrayList<Relation>>
    {
        ...
        protected ArrayList<Relation> doInBackground(String... params) {
            ...
            try {
                ...
                JSONObject jsonParam = new JSONObject();
                jsonParam.put("type", "GetTagRelations");
                jsonParam.put("tag_name", t_name);
